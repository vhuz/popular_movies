...
public class GridListAdapter extends RecyclerView.Adapter<GridListAdapter.NumberViewHolder> {
     ...
     */
    public GridListAdapter(int numberOfItems, ListItemClickListener listener) {
...
//        viewHolder.itemView.setBackgroundColor(backgroundColorForViewHolder);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
         ...
         *                 {@link GridListAdapter#onCreateViewHolder(ViewGroup, int)}
         */
        public NumberViewHolder(View itemView) {
            super(itemView);

            listItemNumberView = (TextView) itemView.findViewById(R.id.grid_item);
